...
func init() {
	...
	// g := flag.String("g", "0.0.0.1:3000", "Set webui url.")
	// 直接写死 AccessToken 时，请更改下面第二个参数
	token := flag.String("t", "", "Set AccessToken of WSClient.")
	// 直接写死 URL 时，请更改下面第二个参数
	url := flag.String("u", "ws://192.168.2.21:3674", "Set Url of WSClient.")
	// 默认昵称
	adana := flag.String("n", "熊会飞", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "ATRI", "atri", "熊会飞", "アトリ"),
